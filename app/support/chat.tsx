...
export default function ChatScreen() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: 'Здравствуйте! Я ChatGPT-ассистент. Чем могу помочь?',
      sender: 'support',
      timestamp: new Date(),
    },
  ]);
  ...
  const sendToChatGPT = async (userMessage: string, currentMessages: Message[]) => {
    try {
      ...
      const chatMessages = [
        {
          role: 'system',
          content: 'Ты полезный ассистент для приложения управления перевозками. Отвечай на русском языке, будь дружелюбным и помогай пользователям с вопросами о логистике, перевозках и использовании приложения.'
        },
